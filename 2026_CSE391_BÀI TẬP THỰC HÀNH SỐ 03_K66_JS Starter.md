...
#### Bước 1: Mở file \& Quan sát bằng Console-->F12
...
> a) JavaScript chạy ở đâu? (Trình duyệt / Server / Cả hai?)-->Trình duyệt + Server
...
>   - `number` là: con số
>   - `string` là: văn bản, chữ cái, chữ số
>   - `boolean` là: biến
...
> Câu hỏi:
> - Dòng log hiển thị gì sau khi em sửa thông tin?Xin chào, mình là Ánh, năm nay mình 20 tuổi
> - Nếu em quên dấu `;` hoặc quên dấu `+`, điều gì xảy ra? Trình duyệt báo lỗi thế nào? SyntaxError
...
> - Khi nào chương trình in `"Yếu"`? khi 5<=score<6.5
...
> - Ưu điểm của việc dùng hàm thay vì lặp lại cùng một đoạn code nhiều lần là gì? Tái sử dụng nhiều lần
